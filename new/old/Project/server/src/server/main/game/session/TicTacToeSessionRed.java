...
public class TicTacToeSessionRed implements RMIGameSession {
    ...
    public TicTacToeSessionRed(RMIGameClient player1, RMIGameClient player2, MainServer mainServer) {
        this();
