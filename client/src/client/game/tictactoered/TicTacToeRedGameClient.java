...
public class TicTacToeRedGameClient implements Runnable, rmigameclient.RMIGameClient {
    ...
    private String sign;
    private TicTacToeRed ticTacToe;

    public TicTacToeRedGameClient(MainController cntl) {
    ...
    public void run() {
        ...
        while (!connected) {
            try {
                ...
                mainController.startGame((ticTacToe = new TicTacToeRed(gameSession, id, sign)).createContent());
